                ...
                <tr>
				  ...
				  <?php if($reccnt>0){?>
					...
					<tr class="<?php print $className?>"> 
				 	...
				 	<TD align="center" class="txt" ><a href="../document_detail.php?doc_id=<?=$line['id']?>" target="_blank" class="orangetxt">View</a>
					<!--<a href="javascript:void(0);" class="orangetxt" onclick="window.open('../document_detail.php?doc_id=<?=$line['id']?>','view_document','menubar=0,height=700,width=850,resizable=0');">View</a>-->
					</TD>
