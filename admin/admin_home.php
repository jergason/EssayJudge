  ...
  <tr>
	...
	<!-- Center Part Begins Here  -->
		<table width="100%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          <tr>
            <td height="21" align="left" background="images/topGreyBar.jpg" class="txt"><strong>Admin Home</strong></td>
          </tr>
          <tr>
            <td height="400" align="center" valign="top" bgcolor="#FFFFFF"><br>
              <table width="95%" height="200" border="0" cellpadding="5" cellspacing="0">
                <tr align="center">
					  ...
					  <b>Welcome to <?=SITE_TITLE?> Administration Suite</b><br>
                        Please use the navigation links on the left side to access 
                        different sections of the main administartion suite.</td>
                </tr>
                <tr align="center">
                  <td>&nbsp;</td>
                </tr>
